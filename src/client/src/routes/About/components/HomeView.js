                    ...
                    <div className="header">
                        <h3 className="title">Getting Started</h3>
                            ...
                            <div style={{padding: "30px", paddingTop:"15px"}}>
                                <h4 style={{margin-top:0px}}>How to use the tool</h4>
                                    <p>
                                    Just type in <code>w</code> + <code>space / tab</code> + <code>your keywords</code> into the address bar. <br>
                                    For more search options you can visit our <a href="howto.html"> full guide</a>.</p>
                                    </p>
                                    ...
                                    <p>
                                        ...
                                        BUT you can import your existing history & bookmarks <a href="analyse_urls.html">here</a>.</p>
                                    </p>
                            </div>
                </div>
            </div>
                    ...
                    <div className="col-md-8">
                        <div className="card">
                            <div className="header">
                             ...
                             <div style={{padding: 30px}}>
                                <p>
                                    <iframe style={{margin-left: 14%}} width="560" height="315" src="https://www.youtube.com/embed/_QJMp2ZIAIQ" frameborder="0" allowfullscreen></iframe>
...
<br>
                                    ...
                                    <br>
                                    <br> Our first tool, The (Re)search engine, is a fully decentralised search engine for the places where you store and communicate your digital knowledge. <br>
