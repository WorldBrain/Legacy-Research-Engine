...
//fetch each URL, download and store. Sure, this can be separated into multiple functions. AAAA MESSSSS!
...
function getcontent(xhttp,callback){
 //requesting HTML code of URL and converting it into DOM tree
        ...
        url = xhttp.responseURL || xhttp
         ...
         // get all visible text from PDF file VIA parsers/pdf/pdf2text.js
        if (url.indexOf(".pdf") !== -1) {
           getPDFtext(url)
            ...
            // get all visible text from HTML file VIA HTML.JS
...
////////////////////////////////////////////////
///
///   THESE FUNCTIONS ARE THERE TO GATHER ALL THE URLS FROM THE IMPORT OF HISTORY AND BOOKMARKS. 
///   DEFINITELY NEED SOME OVERHAUL, AS I USED THEM TO CACHE THE URLS BETWEEN THE PAGES. 
///
///
////////////////////////////////////////////////
